...
public class Chapter5 extends Chapter {
    ...
    private static StoryChoiceList ch5IHideInTheCloset = new StoryChoiceList(R.drawable.phantom_in_closet,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5IHideInTheCloset, 5081)}));

    private static StoryChoiceList ch5IRepossessElodie = new StoryChoiceList(R.drawable.resting_elodie_possessed,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5IRepossessElodie, 5082)}));

    private static StoryChoiceList ch5IRelax = new StoryChoiceList(R.drawable.resting_elodie,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5IRelax, 5083)}));

    private static StoryChoiceList ch5ICallCaitlyn = new StoryChoiceList(R.drawable.resting_elodie,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5ICallCaitlyn, 5084)}));

    private static StoryChoiceList ch5IGreetCaitlyn = new StoryChoiceList(R.drawable.resting_elodie_on_phone,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5IGreetCaitlyn, 5085)}));

    private static StoryChoiceList ch5AmIOK = new StoryChoiceList(R.drawable.resting_elodie_on_phone,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5AmIOK, 5086)}));

    private static StoryChoiceList ch5ITellCaitlynAboutSchool = new StoryChoiceList(R.drawable.resting_elodie_on_phone,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5ITellCaitlynAboutSchool, 5087)}));

    private static StoryChoiceList ch5CaitlynOffersToDrive = new StoryChoiceList(R.drawable.resting_elodie_on_phone,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5CaitlynOffersToDrive, 5088)}));

    private static StoryChoiceList ch5IDeclineCaitlynsOffer = new StoryChoiceList(R.drawable.resting_elodie_on_phone,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5IDeclineCaitlynsOffer, 5089)}));

    private static StoryChoiceList ch5OK = new StoryChoiceList(R.drawable.resting_elodie_on_phone,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5OK, 5090)}));

    private static StoryChoiceList ch5YukioWantsToTalk = new StoryChoiceList(R.drawable.resting_elodie_on_phone,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5YukioWantsToTalk, 5091)}));

    private static StoryChoiceList ch5YukioGreetsMe = new StoryChoiceList(R.drawable.resting_elodie_on_phone,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5YukioGreetsMe, 5092)}));

    private static StoryChoiceList ch5IGreetYukio = new StoryChoiceList(R.drawable.resting_elodie_on_phone,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5IGreetYukio, 5093)}));

    private static StoryChoiceList ch5YukioDislikesMeGettingFreshAir = new StoryChoiceList(R.drawable.resting_elodie_on_phone,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5YukioDislikesMeGettingFreshAir, 5094)}));

    private static StoryChoiceList ch5IWillCallSupervisor = new StoryChoiceList(R.drawable.resting_elodie_on_phone,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5IWillCallSupervisor, 5095)}));

    private static StoryChoiceList ch5IAmApathetic = new StoryChoiceList(R.drawable.resting_elodie_on_phone,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5IAmApathetic, 5096)}));

    private static StoryChoiceList ch5IApologizeToYukio = new StoryChoiceList(R.drawable.resting_elodie_on_phone,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5IApologizeToYukio, 5097)}));

    private static StoryChoiceList ch5YukioDismissesMe = new StoryChoiceList(R.drawable.resting_elodie_on_phone,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5YukioDismissesMe, 5098)}));

    private static StoryChoiceList ch5YukioIsWrong = new StoryChoiceList(R.drawable.resting_elodie,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5YukioIsWrong, 5099)}));

    private static StoryChoiceList ch5IThinkTooLong = new StoryChoiceList(R.drawable.resting_elodie,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5IThinkTooLong, 5100)}));

    private static StoryChoiceList ch5CarleighReturns = new StoryChoiceList(R.drawable.resting_elodie_talk_to_carleigh,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5CarleighReturns, 5101)}));

    private static StoryChoiceList ch5HowWasCarleighsMath = new StoryChoiceList(R.drawable.resting_elodie_talk_to_carleigh,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5HowWasCarleighsMath, 5102)}));

    private static StoryChoiceList ch5CarleighForgets = new StoryChoiceList(R.drawable.resting_elodie_talk_to_carleigh,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5CarleighForgets, 5103)}));

    private static StoryChoiceList ch5CarleighWillBeStar = new StoryChoiceList(R.drawable.resting_elodie_talk_to_carleigh,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5CarleighWillBeStar, 5104)}));

    private static StoryChoiceList ch5ElodieCanBeCool = new StoryChoiceList(R.drawable.resting_elodie_talk_to_carleigh,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5ElodieCanBeCool, 5105)}));

    private static StoryChoiceList ch5CarleighAndILaugh = new StoryChoiceList(R.drawable.resting_elodie_talk_to_carleigh,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5CarleighAndILaugh, 5106)}));

    private static StoryChoiceList ch5HewittCallsMe = new StoryChoiceList(R.drawable.resting_elodie_on_phone_evening,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5HewittCallsMe, 5107)}));

    private static StoryChoiceList ch5IGreetHewitt = new StoryChoiceList(R.drawable.resting_elodie_on_phone_evening,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5IGreetHewitt, 5108)}));

    private static StoryChoiceList ch5CanIHangOutWithHewitt = new StoryChoiceList(R.drawable.resting_elodie_on_phone_evening,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5CanIHangOutWithHewitt, 5109)}));

    private static StoryChoiceList ch5IMightHangOutWithHewitt = new StoryChoiceList(R.drawable.resting_elodie_on_phone_evening,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5IMightHangOutWithHewitt, 5110)}));

    private static StoryChoiceList ch5ISleep = new StoryChoiceList(R.drawable.resting_elodie_night,
            Arrays.asList(new IStoryChoice[]{new StoryChoice(R.string.ch5ISleep, 6001)}));
    ...
    public IStoryChoiceList goToState(int id) {
        switch (id) {
            case 5001:
                return ch5Title;
            case 5002:
                return ch5BekShtiiWakesMe;
            case 5003:
                return ch5PlanIsRoundabout;
            case 5004:
                return ch5RangersCannotCaptureMe;
            case 5005:
                return ch5IEnterVent;
            case 5006:
                return ch5IExitVent;
            case 5007:
                return ch5IReachSchool;
            case 5008:
                return ch5IPossessElodie;
            case 5009:
                return ch5CarleighWakesMe;
            case 5010:
                return ch5ISearchElodiesMemory;
            case 5011:
                return ch5IDressSlowly;
            case 5012:
                return ch5INodAtCarleigh;
            case 5013:
                return ch5IDressElodie;
            case 5014:
                return ch5IEnterLiteratureClass;
            case 5015:
                return ch5IReadPaulsStory;
            case 5016:
                return ch5WhyDidPaulWantToFitIn;
            case 5017:
                return ch5BadWriting;
            case 5018:
                return ch5PutWhatTeacherWants;
            case 5019:
                return ch5PaulHadNothingUnique;
            case 5020:
                return ch5SureCarleighWrites;
            case 5021:
                return ch5WasPaulJustified;
            case 5022:
                return ch5WhyBeYourself;
            case 5023:
                return ch5SureISay;
            case 5024:
                return ch5YouCannotLowerYourself;
            case 5025:
                return ch5CannotAssociateWithLowlyPeople;
            case 5026:
                return ch5CarleighWasTeased;
            case 5027:
                return ch5IAmPragmatic;
            case 5028:
                return ch5WasActivityTerrible;
            case 5029:
                return ch5WriterThinksKidsAreDumb;
            case 5030:
                return ch5IPassByCheerleader;
            case 5031:
                return ch5CheerleaderTripsMe;
            case 5032:
                return ch5HewittConsolesMe;
            case 5033:
                return ch5CheerleaderIsJealous;
            case 5034:
                return ch5CanIStudyWithCarleigh;
            case 5035:
                return ch5IEnterLibrary;
            case 5036:
                return ch5ISeeCarleighsTextbook;
            case 5037:
                return ch5IPrepareToPossessCarleigh;
            case 5038:
                return ch5IPossessCarleigh;
            case 5039:
                return ch5IExamineCarleigh;
            case 5040:
                return ch5ILeaveLibrary;
            case 5041:
                return ch5WhyIsElodieHere;
            case 5042:
                return ch5ElodieIsExhausted;
            case 5043:
                return ch5ElodieIsDizzy;
            case 5044:
                return ch5IEnterMathClass;
            case 5045:
                return ch5IStartMathTest;
            case 5046:
                return ch5MathQuestion1;
            case 5047:
                return ch5MathQuestion1Answer;
            case 5048:
                return ch5MathQuestion4;
            case 5049:
                return ch5MathQuestion4Answer;
            case 5050:
                return ch5MathQuestion9;
            case 5051:
                return ch5MathQuestion9Answer;
            case 5052:
                return ch5MathClassEnds;
            case 5053:
                return ch5IReencounterCheerleader;
            case 5054:
                return ch5IEnterLockerRoom;
            case 5055:
                return ch5IPossessAnanya;
            case 5056:
                return ch5IDressAnanya;
            case 5057:
                return ch5ITieAnanyasHair;
            case 5058:
                return ch5IEnterPEClass;
            case 5059:
                return ch5CoachLectures;
            case 5060:
                return ch5IRaiseHand;
            case 5061:
                return ch5IWouldSubmit;
            case 5062:
                return ch5CoachRespondsToSubmission;
            case 5063:
                return ch5CoachRespondsToRunning;
            case 5064:
                return ch5CoachRespondsToDisarming;
            case 5065:
                return ch5IDisagreeWithCoach;
            case 5066:
                return ch5CoachStartsSpar;
            case 5067:
                return ch5IPartnerWithCheerleader;
            case 5068:
                return ch5CheerleaderAndISpar;
            case 5069:
                return ch5IPinCheerleader;
            case 5070:
                return ch5CoachCheersMe;
            case 5071:
                return ch5CheerleaderFalls;
            case 5072:
                return ch5IBringCoachToCheerleader;
            case 5073:
                return ch5CoachAsksWhatHappened;
            case 5074:
                return ch5CheerleaderIsBruised;
            case 5075:
                return ch5IApologizeToCheerleader;
            case 5076:
                return ch5CoachTellsMeToBeCareful;
            case 5077:
                return ch5INodAtCoach;
            case 5078:
                return ch5PEClassEnds;
            case 5079:
                return ch5IDispossessAnanya;
            case 5080:
                return ch5IHideInTheCloset;
            case 5081:
                return ch5IRepossessElodie;
            case 5082:
                return ch5IRelax;
            case 5083:
                return ch5ICallCaitlyn;
            case 5084:
                return ch5IGreetCaitlyn;
            case 5085:
                return ch5AmIOK;
            case 5086:
                return ch5ITellCaitlynAboutSchool;
            case 5087:
                return ch5CaitlynOffersToDrive;
            case 5088:
                return ch5IDeclineCaitlynsOffer;
            case 5089:
                return ch5OK;
            case 5090:
                return ch5YukioWantsToTalk;
            case 5091:
                return ch5YukioGreetsMe;
            case 5092:
                return ch5IGreetYukio;
            case 5093:
                return ch5YukioDislikesMeGettingFreshAir;
            case 5094:
                return ch5IWillCallSupervisor;
            case 5095:
                return ch5IAmApathetic;
            case 5096:
                return ch5IApologizeToYukio;
            case 5097:
                return ch5YukioDismissesMe;
            case 5098:
                return ch5YukioIsWrong;
            case 5099:
                return ch5IThinkTooLong;
            case 5100:
                return ch5CarleighReturns;
            case 5101:
                return ch5HowWasCarleighsMath;
            case 5102:
                return ch5CarleighForgets;
            case 5103:
                return ch5CarleighWillBeStar;
            case 5104:
                return ch5ElodieCanBeCool;
            case 5105:
                return ch5CarleighAndILaugh;
            case 5106:
                return ch5HewittCallsMe;
            case 5107:
                return ch5IGreetHewitt;
            case 5108:
                return ch5CanIHangOutWithHewitt;
            case 5109:
                return ch5IMightHangOutWithHewitt;
            case 5110:
                return ch5ISleep;
        }
        return null;
