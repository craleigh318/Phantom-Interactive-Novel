 ...
 */
public class IDeclineHangout extends StoryChoice {
    public IDeclineHangout() {
        super(R.string.ch7IDeclineHangout, 7022);
    }

    @Override
    public void select() {
        PotWVN vn = PotWVN.getMainVN();
        vn.getEventFlags().setCh7HungOutWithHewitt(HewittHangout.Refused);
        super.select();
    }
}
