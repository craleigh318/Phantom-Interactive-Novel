...
class ch16Title: StoryPage {
    ...
    init(observer: PhantomOfTheWest) {
        super.init(image: imageName, text: textName, observer: observer, nextState: 16002)
    }
}
...
class ch16DoIGiveUp: StoryPageVoicedKaden {
    ...
    init(observer: PhantomOfTheWest) {
        super.init(image: imageName, text: textName, observer: observer, nextState: 16003)
    }
}
...
class ch16WhatTimeAgo: StoryPageVoicedKaden {
    ...
    init(observer: PhantomOfTheWest) {
        super.init(image: imageName, text: textName, observer: observer, nextState: 16004)
    }
}
...
class ch16BeSuccessful: StoryPageVoicedKaden {
    ...
    init(observer: PhantomOfTheWest) {
        super.init(image: imageName, text: textName, observer: observer, nextState: 16007)
    }
}
...
class ch16DoThatOK: StoryPageVoicedKaden {
    ...
    init(observer: PhantomOfTheWest) {
        super.init(image: imageName, text: textName, observer: observer, nextState: 16008)
    }
}
...
class ch16RebeccaAndIHugged: StoryPageVoicedKaden {
    ...
    init(observer: PhantomOfTheWest) {
        super.init(image: imageName, text: textName, observer: observer, nextState: 17001)
    }
}